...
**Stand: 3. August 2026.** Diese Datei ist die Arbeitsanleitung — abgehakt wird hier.
...
- [ ] 🔑 `begreifbar.ch` registrieren (Anbieter siehe unten). Am 3.8.2026 frei —
...
- [ ] 🔑 Beim Kauf **Auto-Renew einschalten.** Eine abgelaufene Domain ist der
...
- [ ] 🔑 **Apex `begreifbar.ch`** — vier A-Records:
      `185.199.108.153` · `185.199.109.153` · `185.199.110.153` · `185.199.111.153`
- [ ] 🔑 **Apex, IPv6** — vier AAAA-Records:
      `2606:50c0:8000::153` · `2606:50c0:8001::153` · `2606:50c0:8002::153` · `2606:50c0:8003::153`
- [ ] 🔑 **`mathe`** — CNAME auf `go4exercises.github.io.` (mit Punkt am Ende,
      **ohne** Repo-Namen)
- [ ] 🔑 **`physik`** — CNAME auf `go4exercises.github.io.`
- [ ] 🔑 **`www`** — CNAME auf `go4exercises.github.io.` (fängt Leute ab, die
      `www.` davor tippen)
...
- [ ] 🤖 `CNAME`-Datei mit dem Inhalt `mathe.begreifbar.ch` im Repo-Root anlegen.
- [ ] 🔑 Pushen.
- [ ] 🔑 Repo *TALS-Mathe* → **Settings → Pages → Custom domain** prüfen: dort
...
- [ ] 🔑 **Enforce HTTPS** anhaken. Das Zertifikat (Let's Encrypt) stellt GitHub
      selbst aus; es kann bis zu 24 h dauern, bis der Haken anklickbar ist.
- [ ] 🔑 **Domain verifizieren** — GitHub-Konto → Settings → Pages →
