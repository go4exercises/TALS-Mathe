# 3.1 Grundlagen Funktionen — Download-Materialien

Begleitmaterial zum Kapitel **3.1 Grundlagen** des TALS-Mathematik-Lehrmittels für die Berufsmaturität Technik, Architektur, Life Sciences.
...
- **Druckseiten** lassen sich direkt im Browser ausdrucken (Knopf oben rechts „Seite drucken").
- **Anki-Deck** in der Anki-App importieren (Menu → Datei → Importieren → `ankideck.apkg`).
