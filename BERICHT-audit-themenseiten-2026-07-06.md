...
- [x] **T52** Prio-1-Widgets (§4, Punkte 1–10) — **alle 10 Kern-Widgets gebaut** (2026-07-09, CHANGELOG [89]/[90]). Runde 1: g2-2b Diskriminanten-Parabel (5), g5-3 SSW-Fallunterscheidung (7), g4-3 Robustheits-Widget (10), s3-5 Phasor (1). Runde 2: s3-3 Leitterm-Zoom (8), g5-4 Abwickler (2), s2-1 Scheinlösungs-Grafik (6), s4-3c Lot-Widget (4), s4-2b k³-Slider (9), s4-3d Pultdach-Schrägbild mit Durchstosspunkt (3). Sekundäre Zusatz-Ideen aus einzelnen Punkten (windschief-Schrägbild, s4-2c Kugelteil-Querschnitt, g4 Merkmalstyp-Zuordnungsspiel + Manipulations-Demo, g5-4 Symmetrie-Spiegel/Vorzeichen-Trainer) sind nach **T53** (Prio-2) verschoben.
- [x] **T53** Prio-2-Widgets (§4, Liste) — Auswahl nach Sichtung. **Runde 1 erledigt** (2026-07-09, CHANGELOG [91]): die aus T52 verschobenen Sekundär-Widgets — s4-2c Kugelteil-Querschnitt (h-Slider + Grenzfall-Snaps), s4-3c windschief-Schrägbild (zwei Stockwerke, c-Slider), g4-1 Merkmalstyp-Zuordnungsspiel (12 Karten), g4-2 Manipulations-Demo (y-Achsenstart), g5-4 Symmetrie-Spiegel + Vorzeichen-Trainer. **Runde 2 erledigt** (2026-07-09, CHANGELOG [92]): die grössten Hebel der Prio-2-Liste — s4-1 Raumwinkel-Widget + Würfel-Canvas für A1, g5-5 Kreis-Kurve-Kopplung + Lösungs-Trainer, g1-1 Distributiv-Flächenmodell, s1-3 Rechenschieber, s2-2c Betrags-Explorer. **Runde 3 erledigt** (2026-07-10, CHANGELOG [93]): s4-3b Projektionsvektor im Winkel-Labor, g1-4 «√n einschachteln», g1-2 Zahlengeraden-Betrag, s1-1 Regel-Prüfstand. **Runde 4 erledigt** (2026-07-10, CHANGELOG [94]): g2-3 Lösungsfall-Slider + Geradenbüschel, g2-1 Ungleichungs-Zahlenstrahl, g2-2a Vorzeichenkipp, s1-2 Zehnerpotenzen-Umwandler. **Runde 5 erledigt** (2026-07-10, CHANGELOG [95]): g1-3 Zweiklammersatz-Teilerpaare, g3-3 Extremwert-Widget, s4-2a Ellipsen-Münzstapel, s4-3a Polar-Quadranten-Widget. **Runde 6 erledigt** (2026-07-10, CHANGELOG [96]): g3-1 Vertikaltest, g3-2 Steigungsdreieck (ziehbare Punkte), g5-2a Dreiecksungleichung, s3-4a e-Grenzwert. **Runde 7 erledigt** (2026-07-10, CHANGELOG [98]): das LG-5-Geometrie-Bündel — g5-1 Zufallswinkel-Trainer (Kürzen wird mitgeprüft) + Skizzen-Gegenüberstellung, g5-2b Trapez-Scherung + Drachen-Diagonalen, g5-2c Kreisring-Morphing (Ring → Trapez), g5-2d Strahlensatz-Labor mit ziehbaren Punkten. **Runde 8 erledigt** (2026-07-10, CHANGELOG [99]): die Funktions-Seiten des Schwerpunkts — s3-1 Ungleichungs-Labor + Weide-Doppelcanvas, s3-2a Paritaets-Explorer, s3-2b Transformations-Labor, s3-4b log-Leiter + C-14-Datierung. **Runde 9 erledigt** (2026-07-11, CHANGELOG [100]): die letzten drei Seiten — s2-2a Pol-Falle Bruchgleichung (D-Strahl), s2-2b Log-Definitionsmenge (D-Strahl), s3-6 c-Slider am W + Wannen-Labor. **T53 damit vollständig** — die gesamte Prio-2-Liste aus §4 ist gebaut.
- [x] **T54** s3-6 + s2-2c: Video-Platzhalter kuratiert (2026-07-11, CHANGELOG [101]). Kein Betrags-Playlist der bevorzugten Anbieter → Einzelvideo-Fallback §2.1, je ein owner-verifiziertes Video von Mathe by Daniel Jung (s3-6 Übersicht, s2-2c Betragsungleichungen). s2-2a war kein Platzhalter (hatte bereits zwei Wurzel-Playlists). **Damit sind alle Pakete 1–5 des Audits abgeschlossen.**
